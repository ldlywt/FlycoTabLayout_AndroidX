...
public class SegmentTabActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (String title : mTitles_3) {
            mFragments.add(SimpleCardFragment.getInstance("Switch u " + title));
        }
        ...
        mTabLayout_3 = ViewFindUtils.find(mDecorView, R.id.tl_view_page);
    ...
    private void tl_3() {
        ...
        vp_3.setAdapter(new ViewPage2Adapter(this, mFragments));
